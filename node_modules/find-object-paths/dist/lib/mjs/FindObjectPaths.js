export function has(obj, key, value) {
...
export function findObjectPaths(obj, { key, value }) {
    return findPaths(obj, key, value);
}
export function findObjectPathsByKey(obj, key) {
    return findPaths(obj, key);
}
export function findObjectPathsByValue(obj, value) {
    return findPaths(obj, undefined, value);
}
export function findObjectPathsByKeyValue(obj, key, value) {
    return findPaths(obj, key, value);
}
