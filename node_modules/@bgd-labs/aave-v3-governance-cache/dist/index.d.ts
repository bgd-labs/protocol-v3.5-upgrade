...
export type ProposalEvent = ProposalCreatedEvent | ProposalQueuedEvent | ProposalCanceledEvent | ProposalExecutedEvent | ProposalPayloadSentEvent | ProposalVotingActivatedEvent;
...
export declare const FINAL_PROPOSAL_STATES: ProposalState[];
export declare function isProposalFinal(state: ProposalState): boolean;
/**
 * Payload types
 */
...
export declare const FINAL_PAYLOAD_STATES: PayloadState[];
export declare function isPayloadFinal(state: number): boolean;
