...
export declare function readJSONCache<T = any>(filePath: string, filename: string | number | bigint): T | undefined;
export declare function writeJSONCache<T extends {}>(filePath: string, filename: string | number | bigint, json: T): void;
export type TrackingCache = {
	lastSeenBlock: string | bigint;
	isFinal: Record<string, boolean>;
};
export declare const fileSystemStorageAdapter: GovernanceCacheAdapterWithSync;
